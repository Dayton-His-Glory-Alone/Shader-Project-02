...
void init(void)
{
	...
	shaderProgram1 = loadShader("../../src/shader/triangles1.vert", "../../src/shader/triangles1q2.frag");
	shaderProgram2 = loadShader("../../src/shader/triangles2.vert", "../../src/shader/triangles2q2.frag");

	//Set up vertex data (and buffer(s)) and configure vertex attributes
	//yellow house shape
	float firstTriangle[] = {
	-0.5f,  0.5f, 1.0f, // Top-left   far left triangle
...
void display()
{
	...
	glBindVertexArray(VAOs[0]);
	glDrawArrays(GL_TRIANGLES, 0, 9); //This call should output an orange triangle
	...
	glDrawArrays(GL_TRIANGLES, 0, 6); //This call should output a yellow triangle	
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Recitation 02: Question 2 Dayton Rumbold", NULL, NULL);
	if (window == NULL)
	{
